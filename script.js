const SITE_URL = 'https://padawansquest.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Padawan\'s Quest — Sonic Remedy | Soozhee',
        text: 'What would you wake up and love to repeat? Padawan\'s Quest by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
